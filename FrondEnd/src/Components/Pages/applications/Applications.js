  ...
  return (
    <div className="applications-body">
      <div className="tabs">
        ...
        {role === 'tutor'?'':<Link to={`/applications/createapplications?courseCode=${courseCode}&courseName=${courseName}`} className="tab">
          Create Application
        </Link>}
      </div>
      <div className="route-content">
        <Routes>
          ...
          <Route path="applicationprogress" element={role === 'tutor'?<ApplicationProgress />:<AdminViewAppProgress/>} />
